...
# Kingdom Properties[[KingdomProperties]]
...
Size | Resource Die | Control DC Mod | Commodity Storage[[KingdomPropertiesTable]]
:---: | :---: | :---: | :---:
1-9 | d4 | +0 | 4
10-24 | d6 | +1 | 8
25-49 | d8 | +2 | 12
...
**Food** stockpiles are expended to pay for Consumption during the Upkeep phase of a Kingdom turn, but also when faced with famines or other disasters, and to keep armies fed during times of war (as described in those events). Food is gathered with Harvest Crops, Go Fishing, or Gather Livestock.</p>
...
A single hex is limited in what terrain features can overlap:

- These Terrain Features can overlap with any and all other features: Bridge, Landmark, Refuge, Resource
- A hex can have at most one of these: Farmland, Fishery, Freehold, Ranch, Ruins, Settlement, Structure, Work Site.
...
**Fishery** No Fishery hexes exist in the Stolen Lands at the start of Kingmaker; they must be created by the PCs via the Fishing Fleet activity. Much as you can cultivate farms and herds on land, you also can cultivate fisheries of aquatic life, including kelp, shellfish, eels, amphibians, algae, and more as well as traditional fish. Each Fisheries hex reduces your kingdom’s Consumption score by 1, provided the Fishery is in the area of influence of one of its settlements and that settlement has a Pier or Waterfront. Kingdom events may destroy a Fishery, forcing it to be reestablished with a new Fishing Fleet.
...
**Ranch** No Fishery hexes exist in the Stolen Lands at the start of Kingmaker; they must be created by the PCs via the Breed Livestock activity. Raising livestock in the real world is functionally a kind of agriculture, but in terms of a fantasy campaign with varied landscapes, there’s some reason to divide the two. Farmland can be established in hills and plains, but fantasy settlements can be in much less hospitable terrain. Each Ranch reduces your kingdom’s Consumption score by 1, provided the Ranch is in the area of influence of one of its settlements and that settlement has a Stable, Stockyard, or Tannery. Kingdom events may destroy a Ranch, forcing it to be reestablished with a new Breed Livestock action.
...
**Settlement** A Settlement can be a village, town, city, or metropolis; see the Settlement Rules for full details.
...
**Starting Values** When you found a kingdom, it starts with Fame 1 and Infamy 0. Fame and Infamy cannot go below 0. Certain buildings (such as Arenas and Castles) increase Fame. Some events (such as Squatters or a Visiting Celebrity) can increase or reduce Fame or Infamy.

**Level and Size Increases** Whenever your kingdom gains a level or its Size increases to 11, 26, 51, and 101, Fame increases by 1.

**Improvement and Ruin Scores** Each time you take a point of attribute damage from one of your Ruin Scores reaching 10, you gain 1 point of Infamy. Each time your Arts, Community, Scholarship, or Statecraft Focus Focus Bonus increases or you become a master or legendary in any Focus, you gain 1 point of Fame.
...
- *Fame* +1 on Focus checks to Celebrate Holiday, Quell Unrest, or Request Foreign Aid.
- *Infamy* +1 on Focus checks to Collect Taxes, but -1 on Focus checks to Rest and Relax or Request Foreign Aid.

**Expending Fame and Infamy** You can expend Fame and Infamy points as a free action, though each action can taken only once per turn. Spent Fame is permanently lost. Spent Infamy is regained at the end of your turn and is increased by 1, and at the end of any turn in which you expend Infamy, you gain 1 point to a random Ruin Score.
You can expend 2 points to reroll a Focus check. You must use the second result. In addition, if your kingdom is about to fall into Anarchy or increase your Ruin Penalty, you can spend 3 points reduce Unrest or your Ruin Score to 1 point below the value where anarchy or attribute loss would occur.